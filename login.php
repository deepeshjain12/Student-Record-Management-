                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-block ">
                                <img src="img/SRM.png" class="login-logo" alt="logo">
                            </div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user" method="post" action="">
                                        <div class="form-group">
                                            <input type="email" class="form-control form-control-user" name="username" id="exampleInputEmail" placeholder="Enter Email Address..." Required>
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <hr>
                                    <div class="text-center">
                                        <a class="small forgot" onclick="forgot()" href="#">Forgot Password?</a>
                                    </div>
