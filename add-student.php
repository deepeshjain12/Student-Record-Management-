...
<body id="page-top">
    ...
    <div id="wrapper">
      ...
      <h2 class=" mb-4 ml-4"><b>Add Student</b></h2>
            ...
            <div class="card-body py-3">
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    <input type="text" name="secondary_percentage" id="percent" onfocus="sec_calc()" class="form-control" require>
                  </td>
                  <td>
                ...
                <tr>
                  ...
                  <td>
                    <input type="text" name="senior_marksobt" id="sr_obt" class="form-control" require>
                  </td>
                  <td>
                    <input type="text" name="senior_maxmarks" id="sr_max" class="form-control" require>
                  </td>
                  <td>
                    <input type="text" name="senior_percentage" id="sr_percent" onfocus="sr_calc()" class="form-control" require>
                  </td>
                  <td>
                ...
                <tr>
                  ...
                  <td>
                    <input type="text" class="form-control" placeholder="i.e: Graduation" name="graduation" id="" require>
                  </td>
                  <td>
                  ...
                  <td>
                    <input type="text" name="college_marksobt" id="clg_obt" class="form-control" require>
                  </td>
                  <td>
                    <input type="text" name="college_maxmarks" id="clg_max" class="form-control" require>
                  </td>
                  <td>
                    <input type="text" onfocus="clg_calc()" name="college_percent" id="clg_percent" class="form-control" require>
                  </td>                 
                  <td>
                  <select class="form-control text-center" name="college_yop"  require>
                    <option value="">Select</option>
...
<?php include 'logout-model.php';?>
  ...
  <script>
    function sec_calc(){
      const sec_obt = document.getElementById('sec_obt').value;
    const sec_max = document.getElementById('sec_max').value;
    let per = (sec_obt/sec_max)*100;
    document.getElementById('percent').value= per.toFixed(2)+" %";
    }

    function sr_calc(){
      const sec_obt = document.getElementById('sr_obt').value;
    const sec_max = document.getElementById('sr_max').value;
    let per = (sec_obt/sec_max)*100;
    document.getElementById('sr_percent').value= per.toFixed(2)+" %";
    }

    function clg_calc(){
      const sec_obt = document.getElementById('clg_obt').value;
    const sec_max = document.getElementById('clg_max').value;
    let per = (sec_obt/sec_max)*100;
    document.getElementById('clg_percent').value= per.toFixed(2)+" %";
    }
  </script>
</body>
